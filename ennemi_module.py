...
def afficher(jeu):
    """Met à jour et affiche chacun des ennemis dans la liste "ennemis" de la variable jeu selon les propriétés
    disponibles. Initialise cette liste si inexistante.
